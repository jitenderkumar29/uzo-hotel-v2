...
import styles from './PaymentPayTm.module.css';
...
export default function PaymentPayTm() {
  ...
  return (
    <div className={styles.paymentContainer}>
      <div className={styles.googlePayHeader}>
        <Image
          src="/icons/payTmNew.png"
          alt="Google Pay"
          className={styles.PayTmLogo}
          height={100}
          width={100}
        />
        {/* <h2 className={styles.tagline}>Paytm Karo</h2> */}
      </div>

      <form onSubmit={handleSubmit} className={styles.paymentForm}>
        <div className={styles.inputGroup}>
          <label className={styles.inputLabel}>Enter Your PayTM ID</label>
