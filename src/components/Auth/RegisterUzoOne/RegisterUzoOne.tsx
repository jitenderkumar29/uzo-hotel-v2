...
import styles from './RegisterUzoOne.module.css';
        ...
        <div className={styles.wrapper}>
          <div className={styles.leftContainer}>
            ...
            <div className={styles.registerCardDesc}>
              ...
              <div><h3 className={styles.heading}>UZO One Registration</h3></div>
