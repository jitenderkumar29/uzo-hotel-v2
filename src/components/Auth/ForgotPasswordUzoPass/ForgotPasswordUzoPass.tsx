...
import styles from './ForgotPasswordUzoPass.module.css';
        ...
        <div className={styles.leftContainer}>
          ...
          <div className={styles.loginCardDesc}>
            ...
            <span className={styles.descText}>
              Enter your email address associated with your UZO Pass account and we&apos;ll send you a link to reset your password.
            </span>
          </div>
        </div>
...
export default ForgotPasswordUzoPass;