...
import styles from './ForgotPasswordUzoOne.module.css';
        ...
        <div className={styles.leftContainer}>
          ...
          <div className={styles.loginCardDesc}>
            ...
            <span className={styles.descText}>
              Enter your email address associated with your UZO One account and we&apos;ll send you a link to reset your password.
            </span>
          </div>
        </div>
          ...
          <form onSubmit={handleSubmit} className={styles.loginForm}>
            ...
            <div className={styles.register}>
              <span>
                ...
                <Link href="/loginOne" className={styles.link}>
                  Login
                </Link>
              </span>
            </div>
            ...
            <div className={styles.register}>
              <span>
                ...
                <Link href="/registerUzoOne" className={styles.link}>
                  Register
                </Link>
              </span>
            </div>
...
export default ForgotPasswordUzoOne;